...
TEST(TestServiceTypeSupportDispatch, get_handle_function) {
  ...
  EXPECT_DEATH(
    rosidl_typesupport_c__get_service_typesupport_handle_function(nullptr, nullptr), "");
  ...
  rosidl_service_type_support_t null_type_support = get_rosidl_service_type_support(nullptr);
  EXPECT_DEATH(
    rosidl_typesupport_c__get_service_typesupport_handle_function(
      &null_type_support,
      "identifier"), "");
  ...
  rosidl_service_type_support_t type_support = get_rosidl_service_type_support("identifier");
  EXPECT_DEATH(
    rosidl_typesupport_c__get_service_typesupport_handle_function(
      &type_support,
      nullptr), "");
